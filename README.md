...
(4) Modify run_moa.py to include the correct filepath to the output data folder (data_folder_path) and the src data folder (src_folder_path) and the GMAT install folder (gmat_path)
